...
namespace WarMegaChallenege
{
    public class Battle
    {
        ...
        public string preformBattle(Player player1, Player player2)
        {
            Card player1Card = getCard(player1);
            Card player2Card = getCard(player2);

            preformEvalutation(player1, player2, player1Card, player2Card);
            return _sb.ToString();
        }
        ...
        private void preformEvalutation(Player player1, Player player2, Card card1, Card card2)
        {
        ...
        private void war(Player player1, Player player2)
        {
            ...
            preformEvalutation(player1, player2, warCard1, warCard2);
        }
